...
namespace backend\modules\labels\controllers;

use App\JiraApi;
use common\modules\labels\services\LabelService;
use Yii;
use common\modules\labels\records\Label;
use common\modules\labels\searches\LabelSearch;
use yii\base\Module;
...
class LabelController extends Controller
{
    ...
    {
        $labels = \Yii::$app->jira->getAllLabels();

        foreach ($labels as $label) {
            LabelService::make(['name' => $label['value']]);
        }

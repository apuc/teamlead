 ...
 * @var common\modules\labels\searches\LabelSearch $searchModel
 */
...
<div class="label-index">
    ...
    <p>
        <?php /* echo Html::a('Create Label', ['create'], ['class' => 'btn btn-success'])*/  ?>
    </p>
                ...
                'buttons' => [
                    'update' => function ($url, $model) {
                        return Html::a('<span class="glyphicon glyphicon-pencil"></span>',
                            Yii::$app->urlManager->createUrl(['labels/label/view', 'id' => $model->id, 'edit' => 't']),

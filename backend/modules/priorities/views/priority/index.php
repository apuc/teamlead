 ...
 * @var common\modules\priorities\searches\PrioritySearch $searchModel
 */
...
<div class="priority-index">
    ...
    <p>
        <?php /* echo Html::a('Create Priority', ['create'], ['class' => 'btn btn-success'])*/  ?>
    </p>
                ...
                'buttons' => [
                    'update' => function ($url, $model) {
                        return Html::a('<span class="glyphicon glyphicon-pencil"></span>',
                            Yii::$app->urlManager->createUrl(['priorities/priority/view', 'id' => $model->id, 'edit' => 't']),
